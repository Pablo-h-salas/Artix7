...
HD_PWD='D:/pablo/Desktop/MIS_APUNTES/Mis_repositorios/Artix7/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiCircuito.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiCircuito.tcl
