...
HD_PWD='D:/pablo/Desktop/MIS_APUNTES/Mis_repositorios/Artix7/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MiCircuito.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MiCircuito.tcl -notrace
